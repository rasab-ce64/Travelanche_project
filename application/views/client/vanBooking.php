...
>>>>>>> 75571b9135415e91d2ca2d53c008ba7637da0d1d
            ...
            <h1 class="form-signin-heading">Van Booking</h1>
...
=======
            <span class="fa fa-car"></span> &nbsp; <label>Van Seats</label>
            <div class="radio">
                <label><input type="radio" name="optradio">8-seater</label>
            </div>
            <div class="radio">
                <label><input type="radio" name="optradio">13-Seater</label>
            </div>
            <div class="radio">
                <label><input type="radio" name="optradio">15-seater</label>
>>>>>>> 75571b9135415e91d2ca2d53c008ba7637da0d1d
            </div>
