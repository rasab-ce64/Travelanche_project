...
<!--							<img  src="--><?php //echo base_url('assets/images/slider/slider_one.jpg'); ?><!--" class="img-responsive" alt="">-->
<!--					   </div>-->
<!--					   <div class="item">-->
<!--							<img  src="--><?php //echo base_url('assets/images/slider/slider_one.jpg'); ?><!--" class="img-responsive" alt="">-->
<!--					   </div> -->
...
<!--			</div><!--/#about-slider-->
			...
			<img style="height: 600px; width: 100%;" class="img-responsive" src="<?php echo base_url('assets/images/slider/slider_5.jpg')?>"> </img>
...
<!--									<a href="#"><img class="media-object" src="--><?php //echo base_url('assets/images/man4.jpg'); ?><!--" > </a>-->
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										...
										<li class="btn"><a href="#">UI</a></li>
										<li class="btn"><a href="#">UX</a></li> 
										<li class="btn"><a href="#">iOS</a></li> <br>
										<li class="btn"><a href="#">Big Data</a></li>
									</ul>
									<ul class="social_icons">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li> 
