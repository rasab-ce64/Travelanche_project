        ...
        <div class="col-sm-4">
            <div class="panel panel-default text-center">
                ...
                <div class="panel-footer">
                    ...
                    <a type="button" class="btn btn-lg" name="bid_now" data-toggle="modal" data-target="#modal" onclick="window.location='<?php echo site_url("company_logged_in/bids_By_Other_Companies/$row->id");?>'">Bids on Trip</a>
