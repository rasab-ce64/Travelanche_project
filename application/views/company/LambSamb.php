...
<div class="wrapper">
    ...
    <div class="container">
        <form class="form-signin" method="POST" action="<?php echo site_url('company_logged_in/place_bid'); ?>" >
            ...
            <h2 class="form-signin-heading">LambSamb Package</h2>
            ...
            <input type="number"  class="form-control" name="rate_per_day" placeholder="Total fare" autofocus="" required=""/>
            <span class="text-danger"> <?php echo form_error('number'); ?></span>

            <label class="checkbox">
                <input type="checkbox" value="Bid-bylambSamb" id="bachat" name="lambSamb"> Bid by Bachat
            </label>
            ...
            <!--total fare -->
            <input type="number" style="display: none" id="totalFare" class="form-control" name="total_fare" placeholder="Enter your Rate/day" autofocus="" />
            <span class="text-danger"> <?php echo form_error('number'); ?></span>

            <button class="btn btn-sm btn-primary" name="bid" type="submit">Place Bid</button>
        </form>
    </div>
    </body>
</div>
